...
const styles: Record<CalloutType, { icon: typeof Info; className: string }> = {
  ...
  tip: { icon: Lightbulb, className: "border-brand-300/40 bg-brand-50 text-brand-800 dark:border-brand-700/40 dark:bg-brand-950/50 dark:text-brand-200" },
...
export function Callout({
  ...
  return (
    <div className={cn("not-prose my-6 flex gap-3 rounded-2xl border p-4", className)}>
